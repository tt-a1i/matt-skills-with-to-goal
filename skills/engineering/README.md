...
- **[goal-crafter](./goal-crafter/SKILL.md)** — *(fork addition)* Standalone rules for a verifiable goal and its target-harness formatting, with a no-reinterview mode for already-approved evidence.
